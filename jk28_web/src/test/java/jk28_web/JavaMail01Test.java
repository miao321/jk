...
public class JavaMail01Test {
	...
	public void testJavaMail() throws Exception{
		...
		//设置发送者
		Address fromAddress = new InternetAddress("18814127356@163.com");//邮件地址
		message.setFrom(fromAddress);//设置发送的邮件地址
		
		//设置接收者
		Address toAddress = new InternetAddress("771969163@qq.com");//邮件地址
		...
		//火箭连接到服务器上
		transport.connect("smtp.163.com","18814127356@163.com","LiXiaoHui0701");
